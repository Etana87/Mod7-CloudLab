...
import type { ProblemSeverity, UserContext } from '@redocly/openapi-core/lib/walk';
import type { Oas3PreprocessorsSet, SpecMajorVersion, Oas3DecoratorsSet, Oas2RuleSet, Oas2PreprocessorsSet, Oas2DecoratorsSet, Oas3RuleSet, SpecVersion, Async2PreprocessorsSet, Async2DecoratorsSet, Async2RuleSet, Async3PreprocessorsSet, Async3DecoratorsSet, Async3RuleSet, Arazzo1RuleSet, Arazzo1PreprocessorsSet, Arazzo1DecoratorsSet, RuleMap } from '@redocly/openapi-core/lib/oas-types';
import type { NodeType } from '@redocly/openapi-core/lib/types';
import type { SkipFunctionContext } from '@redocly/openapi-core/lib/visitors';
