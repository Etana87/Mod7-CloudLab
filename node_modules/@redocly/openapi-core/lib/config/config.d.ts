import { SpecVersion, SpecMajorVersion } from '@redocly/openapi-core/lib/oas-types';
import type { NormalizedProblem } from '@redocly/openapi-core/lib/walk';
import type { Oas2RuleSet, Oas3RuleSet, Async3RuleSet, Arazzo1RuleSet } from '@redocly/openapi-core/lib/oas-types';
import type { NodeType } from '@redocly/openapi-core/lib/types';
import type { DecoratorConfig, Plugin, PreprocessorConfig, Region, ResolveConfig, ResolvedApi, ResolvedConfig, ResolvedStyleguideConfig, RuleConfig, RuleSettings, Telemetry, ThemeRawConfig } from '@redocly/openapi-core/lib/config/types';
