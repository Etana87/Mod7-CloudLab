...
import type { Stack } from '@redocly/openapi-core/lib/utils';
import type { UserContext, ResolveResult, ProblemSeverity } from '@redocly/openapi-core/lib/walk';
import type { Location } from '@redocly/openapi-core/lib/ref-utils';
import type { Oas3Definition, Oas3ExternalDocs, Oas3Info, Oas3Contact, Oas3Components, Oas3License, Oas3Schema, Oas3Header, Oas3Parameter, Oas3Operation, Oas3PathItem, Oas3ServerVariable, Oas3Server, Oas3MediaType, Oas3Response, Oas3Example, Oas3RequestBody, Oas3Tag, OasRef, Oas3SecurityScheme, Oas3SecurityRequirement, Oas3Encoding, Oas3Link, Oas3Xml, Oas3Discriminator, Oas3Callback } from '@redocly/openapi-core/lib/typings/openapi';
import type { Oas2Definition, Oas2Tag, Oas2ExternalDocs, Oas2SecurityRequirement, Oas2Info, Oas2Contact, Oas2License, Oas2PathItem, Oas2Operation, Oas2Header, Oas2Response, Oas2Schema, Oas2Xml, Oas2Parameter, Oas2SecurityScheme } from '@redocly/openapi-core/lib/typings/swagger';
import type { Async2Definition } from '@redocly/openapi-core/lib/typings/asyncapi';
import type { Async3Definition } from '@redocly/openapi-core/lib/typings/asyncapi3';
import type { ArazzoDefinition, ArazzoSourceDescription, CriteriaObject, ExtendedOperation, InfoObject, OnFailureObject, OnSuccessObject, OpenAPISourceDescription, Parameter, Replacement, RequestBody, SourceDescription, Step, Workflow } from '@redocly/openapi-core/lib/typings/arazzo';
